...
| ----------- | ----------- |
| Test 1 - Max of positive numbers | 12.5 |
| Test 2 - Max of negative numbers | 12.5 |
| Test 3 - Max of positive and negative numbers | 12.5 |
| Test 4 - Max of repeating numbers | 12.5 |
| **Total** | **50** |

## Review Format
This assignment is **auto reveiwed** meaning that your grade will reflect your code passing the test items above. Each test calls your **int find_max(int num1, int num2, int num3)** function, in order for each test to run it is important that you do not alter the name of the functions provided to you in the **src** folder. 
